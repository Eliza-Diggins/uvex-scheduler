...
from uvex_transient_toolkit.models.core import Lightcurve, LogNormalPrior, NormalPrior, Parameter
...
class VillarLightcurve(Lightcurve):
    ...
    See Also
    --------
    uvex_transient_toolkit.models.supernovae.VillarCoolingBlackbodySED
